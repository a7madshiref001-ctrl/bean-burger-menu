...
(function (global) {
  ...
  var ui = {
    ...
    burger: S + '<path d="M5 9.5c0-2.8 3.1-4.5 7-4.5s7 1.7 7 4.5"/><path d="M4.5 13h15"/><path d="M5 16.5h14c0 1.7-1.4 3-3.2 3H8.2C6.4 19.5 5 18.2 5 16.5Z"/><path d="M8 9.7h.01M11 8.9h.01M14 9.7h.01M16 9h.01"/></svg>',
    fries: S + '<path d="M7 9.5 6 19a1.5 1.5 0 0 0 1.5 1.5h9A1.5 1.5 0 0 0 18 19l-1-9.5"/><path d="M6.5 9.5h11"/><path d="M9 9.5V5M12 9.5V3.5M15 9.5V5"/></svg>',
    cup: S + '<path d="M6 8h12l-1 11.2a1 1 0 0 1-1 .8H8a1 1 0 0 1-1-.8L6 8Z"/><path d="M5.5 8h13"/><path d="M9 4.5c1-1 2-1 3 0M13 4c.8-.8 1.6-.8 2.4 0"/></svg>',
